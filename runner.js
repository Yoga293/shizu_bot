...
number = '6289503657396@s.whatsapp.net'

require('./srv/zero.js')
nocache('./srv/zero.js', module => console.log(`${module} Telah Di Updated... Jangan Lupa Subscribe CHANNEL HY FAUZI`))
...
console.log(color('[•] [ FAUZI GANTENG ] [•]'))
console.log(color('Please Follow Me On Sosial Media'))
console.log(color(' ==============================================='))
console.log(color('│ ○ Youtube : https://youtube.com/Hyfauzi                     '))
console.log(color('│ ○ Instagram : https://instagram.com/spnx.fauzi                 '))
console.log(color('│ ○ Tiktok : https://tiktok.com/@inifauzi03                        '))
console.log(color('│ ○ Github : https://github.com/Zyy                     '))
console.log(color(' ==============================================='))
zero.on('qr', () => {
...
zero.on('open', () => {
success('2', 'Bot Telah Tersambung... Jangan Lupa Subscribe HyFauzi')
})
...
zero.sendMessage(anu.jid, "𝐇𝐚𝐲!.. SAYA REALZI BOT SAYA ADALAH ROBOT YANG BISA MEMBANTU ANDA DALAM MENGGUNAKAN WHATSAPP!!.", "conversation")
}
...
sendButImage(anu.jid, teks, `©Created By shizu`, img,but = [{buttonId:`hallo`, 
...
img = await getBuffer(ppUrl)
teks = `Bye Bye @${num.split('@')[0]}\nGroup Berkurang Selamat Tinggal Di Group: ${mdata.subject}`
sendButImage(anu.jid, teks, `©Created By Fauzi`, img,but= [{buttonId: `byebye`, buttonText: {displayText: `SELAMAT TINGGAL!!!`}, type: 1}], options = {contextInfo: {mentionedJid: [num, number]}, thumbnail: Buffer.alloc(0)})
}
